...
<div class="flex min-h-screen">
    ...
    <aside class="sidebar w-60 min-h-screen flex flex-col fixed left-0 top-0 z-40" style="box-shadow:1px 0 0 #e2e8f0;">
        ...
        <div class="px-5 py-4 border-b border-gray-100">
            <a href="<%= userRole.equals("ADMIN") ? request.getContextPath()+"/admin/dashboard.jsp" : request.getContextPath()+"/employee/dashboard.jsp" %>" class="flex items-center gap-2.5 no-underline">
