...
<div class="grid grid-cols-1 md:grid-cols-3 gap-5">
    <a href="my-attendance.jsp" class="card p-6 flex flex-col items-center gap-3 text-center hover:border-green-300 transition-all group no-underline" style="box-shadow:0 1px 4px rgba(0,0,0,.06);">
    ...
    <a href="apply-leave.jsp" class="card p-6 flex flex-col items-center gap-3 text-center hover:border-amber-300 transition-all group no-underline" style="box-shadow:0 1px 4px rgba(0,0,0,.06);">
    ...
    <a href="my-payslip.jsp" class="card p-6 flex flex-col items-center gap-3 text-center hover:border-indigo-300 transition-all group no-underline" style="box-shadow:0 1px 4px rgba(0,0,0,.06);">
