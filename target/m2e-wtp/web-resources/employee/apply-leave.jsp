...
<div class="max-w-xl">
    ...
    <div class="card p-6" style="box-shadow:0 1px 4px rgba(0,0,0,.06);">
        ...
        <% } %>
        <form action="<%= request.getContextPath() %>/leave" method="post" class="space-y-5">
            ...
            <div class="form-grid">
                <div>
                    <label class="input-label" for="startDate">From Date *</label>
                    <input type="date" id="startDate" name="startDate" class="input-field" required onchange="calcDays()">
                </div>
                <div>
                    <label class="input-label" for="endDate">To Date *</label>
                    <input type="date" id="endDate" name="endDate" class="input-field" required onchange="calcDays()">
                </div>
            </div>
            ...
            <div>
                <label class="input-label" for="contactDuring">Contact During Leave</label>
                <input type="tel" id="contactDuring" name="contactDuring" class="input-field" placeholder="+91 98765 43210">
            </div>
            <div class="flex gap-3 pt-1">
                ...
                <a href="my-leaves.jsp" class="btn-secondary no-underline">View History</a>
            </div>
        </form>
    </div>
</div>
