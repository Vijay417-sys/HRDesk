...
<div class="card p-6 mb-7" style="box-shadow:0 1px 4px rgba(0,0,0,.06);">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
        <a href="<%= request.getContextPath() %>/admin/add-employee.jsp" class="flex flex-col items-center gap-2.5 p-4 rounded-xl border border-indigo-100 bg-indigo-50 hover:bg-indigo-100 transition-all text-center group no-underline">
        ...
        <a href="<%= request.getContextPath() %>/admin/payroll-generate.jsp" class="flex flex-col items-center gap-2.5 p-4 rounded-xl border border-green-100 bg-green-50 hover:bg-green-100 transition-all text-center no-underline">
        ...
        <a href="<%= request.getContextPath() %>/admin/leave-requests.jsp" class="flex flex-col items-center gap-2.5 p-4 rounded-xl border border-amber-100 bg-amber-50 hover:bg-amber-100 transition-all text-center no-underline">
        ...
        <a href="<%= request.getContextPath() %>/admin/attendance-report.jsp" class="flex flex-col items-center gap-2.5 p-4 rounded-xl border border-sky-100 bg-sky-50 hover:bg-sky-100 transition-all text-center no-underline">
...
<div class="card" style="box-shadow:0 1px 4px rgba(0,0,0,.06);">
    <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
        ...
        <a href="<%= request.getContextPath() %>/admin/view-employees.jsp" class="text-xs font-medium text-indigo-600 hover:text-indigo-800 no-underline">View All →</a>
    </div>
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="view-employees.jsp" class="text-xs text-indigo-600 hover:underline font-medium no-underline">Edit</a>
                    </td>
                </tr>
                <% } } else { %>
                <tr>
                    <td colspan="5" class="py-12 text-center">
                        <div class="flex flex-col items-center gap-2">
                            ...
                            <a href="add-employee.jsp" class="text-sm text-indigo-600 font-medium hover:underline">Add first employee →</a>
                        </div>
                    </td>
                </tr>
                <% } %>
