...
<div class="card p-6 mb-7" style="box-shadow:0 1px 4px rgba(0,0,0,.06);">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
        <a href="<%= request.getContextPath() %>/employee/add" class="flex flex-col items-center gap-2.5 p-4 rounded-xl border border-indigo-100 bg-indigo-50 hover:bg-indigo-100 transition-all text-center group no-underline">
...
<div class="card" style="box-shadow:0 1px 4px rgba(0,0,0,.06);">
    <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
        ...
        <a href="<%= request.getContextPath() %>/employee/list" class="text-xs font-medium text-indigo-600 hover:text-indigo-800 no-underline">View All →</a>
    </div>
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="<%= request.getContextPath() %>/employee/edit?id=<%= emp.getEmployeeId() %>" class="text-xs text-indigo-600 hover:underline font-medium no-underline">Edit</a>
                    </td>
                </tr>
                <% } } else { %>
                <tr>
                    <td colspan="5" class="py-12 text-center">
                        <div class="flex flex-col items-center gap-2">
                            ...
                            <a href="<%= request.getContextPath() %>/employee/add" class="text-sm text-indigo-600 font-medium hover:underline">Add first employee →</a>
                        </div>
                    </td>
                </tr>
                <% } %>
