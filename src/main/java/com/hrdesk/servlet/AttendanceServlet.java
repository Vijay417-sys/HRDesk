...
public class AttendanceServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("/mark".equals(action)) {
            ...
            att.setAttendanceStatus(request.getParameter("status") != null ? request.getParameter("status") : "PRESENT");
            ...
            try {
                if (checkIn  != null && !checkIn.isEmpty())  att.setCheckIn(java.sql.Time.valueOf(checkIn + ":00"));
                if (checkOut != null && !checkOut.isEmpty()) att.setCheckOut(java.sql.Time.valueOf(checkOut + ":00"));
            } catch (Exception ignored) {}
