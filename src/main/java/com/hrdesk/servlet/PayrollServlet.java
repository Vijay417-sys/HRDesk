...
public class PayrollServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("/generate".equals(action) || "/add".equals(action)) {
            ...
            if (empIdStr != null && !empIdStr.isEmpty()) payroll.setEmployeeId(Integer.parseInt(empIdStr));
            ...
            if (basicStr     != null && !basicStr.isEmpty())     payroll.setBasicSalary(Double.parseDouble(basicStr));
            if (bonusStr     != null && !bonusStr.isEmpty())     payroll.setBonus(Double.parseDouble(bonusStr));
            if (deductionStr != null && !deductionStr.isEmpty()) payroll.setDeduction(Double.parseDouble(deductionStr));
