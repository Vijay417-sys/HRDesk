...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
    ...
    <a href="<%= request.getContextPath() %>/employee/add" class="btn-primary no-underline">
                ...
                <tr>
                    ...
                    <td>
                        <div class="flex items-center gap-2">
                            <a href="<%= request.getContextPath() %>/employee/edit?id=<%= emp.getEmployeeId() %>" class="text-xs text-indigo-600 hover:text-indigo-800 font-medium no-underline">Edit</a>
                ...
                <tr>
                    <td colspan="8" class="py-16 text-center">
                        <div class="flex flex-col items-center gap-2">
                            ...
                            <a href="<%= request.getContextPath() %>/employee/add" class="text-sm text-indigo-600 font-medium hover:underline">Add your first employee →</a>
                        </div>
                    </td>
                </tr>
                <% } %>
...
function deleteEmployee(id) {
    if (confirm('Delete this employee? This cannot be undone.')) {
        window.location.href = '<%= request.getContextPath() %>/employee/delete?id=' + id;
    }
}
</script>
