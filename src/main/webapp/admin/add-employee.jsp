...
<div class="max-w-2xl">
    ...
    <div class="card" style="box-shadow:0 1px 4px rgba(0,0,0,.06);">
        ...
        <form action="<%= request.getContextPath() %>/employee/<%= isEdit ? "edit" : "add" %>" method="post" class="p-6 space-y-5">
            <% if (isEdit) { %>
            ...
            <div class="flex gap-3 pt-2">
                ...
                <a href="<%= request.getContextPath() %>/employee/list" class="btn-secondary no-underline">Cancel</a>
            </div>
        </form>
    </div>
</div>
